...
ap.add_argument("-d", "--dataset", required=True, help="path to HDF5 dataset")
ap.add_argument("-m", "--model", required=True, help="path to output model")
ap.add_argument("-j", "--jobs", type=int, default=1, help="of jobs to run when tuning hyparparameters")
